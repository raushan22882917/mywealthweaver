      ...
      {selectedDateEvents && (
        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-3 px-1">
              {selectedDateEvents.events.map((stock, index) => (
                ...
                >
                  {/* Stock card with fixed dimensions */}
                  <div className="relative w-[76px] h-[76px] mb-1">
                    {/* Logo container with border */}
                    <div className="absolute inset-0 bg-white rounded-md overflow-hidden border-2 border-green-500 group-hover:border-red-500 transition-colors">
                      <img
                    ...
                    <div className="absolute inset-0 rounded-md border-2 border-red-500 opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  {/* Symbol text */}
                  <div className="w-full bg-gray-800/80 rounded-sm py-1 text-center group-hover:bg-red-900/80 transition-colors">
                    <p className="text-xs font-bold text-red-400 group-hover:text-red-300">
                      {stock.symbol}
                    </p>
                  </div>

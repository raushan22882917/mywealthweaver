...
const DividendCalendar = () => {
  ...
  useEffect(() => {
    const fetchDividendData = async () => {
      try {
        // Fetch dividend reports with ex_dividend_date
        ...
        // Filter out events without ex_dividend_date
        const validEvents = eventsWithLogos.filter(event => event.ex_dividend_date);
        setDividendEvents(validEvents);
      } catch (error) {

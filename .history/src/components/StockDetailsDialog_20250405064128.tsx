    ...
    const fetchCompanyProfile = async () => {
      ...
      try {
        ...
        setCompanyProfile({
          ...
          auditRisk: data.audit_risk || 0,
          boardRisk: data.board_risk || 0,
          compensationRisk: data.compensation_risk || 0,
          shareHolderRightsRisk: data.shareholder_rights_risk || 0,
          ...
          fiveYearAvgDividendYield: data.five_year_avg_dividend_yield || 0,
          beta: data.beta || 0,
          trailingPE: data.trailing_pe || 0,
          forwardPE: data.forward_pe || 0,
          priceToSalesTrailing12Months: data.price_to_sales_trailing_12months || 0,
          fiftyDayAverage: data.fifty_day_average || 0,
          twoHundredDayAverage: data.two_hundred_day_average || 0,
          trailingAnnualDividendRate: data.trailing_annual_dividend_rate || 0,
          trailingAnnualDividendYield: data.trailing_annual_dividend_yield || 0,
          profitMargins: data.profit_margins || 0,
          heldPercentInsiders: data.held_percent_insiders || 0,
          heldPercentInstitutions: data.held_percent_institutions || 0,
          bookValue: data.book_value || 0,
          priceToBook: data.price_to_book || 0
        });
      } catch (error) {

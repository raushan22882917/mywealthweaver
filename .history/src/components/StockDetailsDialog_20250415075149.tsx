          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Popover>
                ...
                <PopoverContent className="w-80 p-4 text-sm rounded-xl shadow-lg bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                  <p className="font-semibold text-lg mb-3 text-gray-800 dark:text-gray-200">Similar to {stock.Symbol}</p>
                  <div className="overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700">
                    <table className="w-full text-sm">
                      <thead className="bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-300">
                        <tr>
                          <th className="px-4 py-2 text-left font-medium">Symbol</th>
                          <th className="px-4 py-2 text-right font-medium">Dividend Yield</th>
                      ...
                      <tbody>
                        {similarCompanies.slice(0, 5).map((company) => (
                          ...
                          >
                            <td className="px-4 py-2 font-medium text-blue-600 dark:text-blue-400 flex items-center gap-2">
                              <div
                            ...
                            <td className="px-4 py-2 text-right">
                              {company.dividend_yield ? company.dividend_yield : 'N/A'}
                            </td>
                            <td className="px-4 py-2 text-right">
                              <span className={`font-medium ${Math.random() > 0.5 ? 'text-green-500' : 'text-red-500'}`}>

          ...
          >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
              {selectedDateEvents.events.map((stock, index) => (
                <div
                  key={index}
                  className="inline-flex flex-col items-center p-3 rounded-xl bg-gray-800/50 hover:bg-gray-700/50 transition-colors
                            border-2 border-red-500 hover:border-red-400 cursor-pointer group relative
                            overflow-hidden w-max mx-auto"
                ...
                >
                  ...
                  <div className="z-10 flex flex-col items-center">
                    <div className="w-14 h-14 bg-white rounded-lg overflow-hidden mb-2 shadow-md flex items-center justify-center

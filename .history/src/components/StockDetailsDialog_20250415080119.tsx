                      ...
                      <tbody>
                        {similarCompanies.slice(0, 5).map((company) => (
                          ...
                          >
                            ...
                            <td className="px-3 py-2 text-right">
                              <span className="text-xs text-gray-500 truncate block max-w-[100px] overflow-hidden">
                                {company.risks ? (company.risks.length > 15 ? company.risks.substring(0, 15) + '...' : company.risks) : 'N/A'}
                              </span>
                            </td>
                          </tr>
                        ))}

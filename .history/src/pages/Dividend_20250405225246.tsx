...
const Dividend: React.FC = () => {
  ...
  // Function to open the stock details dialog
  const openStockDialog = useCallback((stock: DividendData) => {
              ...
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <div
                    ...
                    onClick={() => {
                      openStockDialog(hoveredStockDetails.stock);
                    }}
                  >

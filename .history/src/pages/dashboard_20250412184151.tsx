        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>Ex-Dividend Date (Symbol)</TableHead>
              <TableHead>Ex-Dividend Date (Report)</TableHead>
          ...
          <TableBody>
            {sortStocks(filteredStocks).map((stock) => (
              <TableRow key={stock.symbol}>
                ...
                <TableCell>{stock.exDividendDate || 'N/A'}</TableCell>
                <TableCell>{stock.reportExDividendDate || 'N/A'}</TableCell>
                <TableCell>{stock.payoutDate || 'N/A'}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
...
const fetchDividendData = async (symbol: string) => {
  try {
    ...
    const transformedData = {
      ...
      reportExDividendDate: reportData?.ex_dividend_date || '',

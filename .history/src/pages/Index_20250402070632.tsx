                ...
                <div className="backdrop-blur-lg bg-white/5 border border-white/10 rounded-2xl p-6 shadow-2xl">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">Real-time insights for smart investing</p>
                    </div>
                  </div>

                  <div className="space-y-4 mb-6">
                    <div className="bg-white/5 rounded-xl p-4 border border-white/10 hover:border-green-500/50 transition-all">
                      <div className="flex items-center gap-3 mb-2">
                        <BarChart className="h-5 w-5 text-blue-400" />
                        <h3 className="font-semibold text-white">Advanced Analytics</h3>
                      </div>
                      <p className="text-gray-400">Leverage AI-powered insights to identify market trends and opportunities</p>
                    </div>

                    <div className="bg-white/5 rounded-xl p-4 border border-white/10 hover:border-blue-500/50 transition-all">
                      <div className="flex items-center gap-3 mb-2">
                        <Target className="h-5 w-5 text-purple-400" />
                        <h3 className="font-semibold text-white">Smart Portfolio Tracking</h3>
                      </div>
                      <p className="text-gray-400">Monitor your investments with precision and real-time updates</p>
                    </div>

                    <div className="bg-white/5 rounded-xl p-4 border border-white/10 hover:border-yellow-500/50 transition-all">
                      <div className="flex items-center gap-3 mb-2">
                        <MessageSquare className="h-5 w-5 text-yellow-400" />
                        <h3 className="font-semibold text-white">Expert Insights</h3>
                      </div>
                      <p className="text-gray-400">Access curated market analysis from industry professionals</p>
                    </div>
                  </div>

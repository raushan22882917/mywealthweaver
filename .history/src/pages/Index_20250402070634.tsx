      ...
      <main>
        ...
        <div className="relative h-[500px] overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4 max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 w-full max-w-7xl mx-auto px-4">
              {/* Left Side - Hero Content */}
              <div className="w-full md:w-1/2 animate-fade-in">
                <div className="flex items-center mb-10">
                  <TrendingUp className="h-12 w-12 text-green-400 mr-4" />
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-blue-500">
                    IntelligentInvestor+
                  </h1>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-center">
                  <Button 
                    size="lg"
                    className="bg-green-500 hover:bg-green-600 text-white px-8 py-6 rounded-xl text-lg font-semibold transition-all transform hover:scale-105 flex items-center gap-2 border-2 border-green-400 shadow-lg shadow-green-500/20 w-full sm:w-auto"
                  >
                  ...
                  <Link to="/education" className="w-full sm:w-auto">
                    <Button 
                      variant="outline"
                      size="lg"
                      className="bg-transparent border-2 border-blue-400 text-blue-400 hover:bg-blue-400/10 px-8 py-6 rounded-xl text-lg font-semibold transition-all transform hover:scale-105 flex items-center gap-2 shadow-lg shadow-blue-500/20 w-full"
                    >
              ...
              {/* Right Side - Market Intelligence Box */}
              <div className="w-full md:w-1/2 animate-fade-in">
                <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-8 shadow-2xl hover:shadow-green-500/10 transition-all duration-500">
                  {/* Header Section */}
                  <div className="flex items-center gap-4 mb-8">
                    <div className="p-4 bg-gradient-to-br from-green-500/20 to-blue-500/20 rounded-2xl shadow-inner">
                      <TrendingUp className="h-10 w-10 text-green-400" />
                    </div>
                    <div>
                      <h2 className="text-3xl font-bold text-white bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-blue-400">
                        Market Pulse
                      </h2>
                      <p className="text-gray-400 text-lg">Real-time market insights</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-8">
                    <div className="bg-white/5 rounded-2xl p-4 border border-white/10">
                      <div className="text-green-400 text-2xl font-bold">+23.5%</div>
                  ...
                  <div className="space-y-4">
                    <div className="group bg-gradient-to-r from-white/5 to-white/10 rounded-2xl p-5 border border-white/10 hover:border-green-500/50 hover:shadow-lg transition-all duration-300 cursor-pointer">
                      ...
                      <p className="text-gray-400 leading-relaxed pl-[52px]">
                        Predictive market analysis powered by advanced machine learning
                      </p>
                    </div>

                    <div className="group bg-gradient-to-r from-white/5 to-white/10 rounded-2xl p-5 border border-white/10 hover:border-purple-500/50 hover:shadow-lg transition-all duration-300 cursor-pointer">
                      <div className="flex items-center gap-4 mb-3">
                      ...
                      <p className="text-gray-400 leading-relaxed pl-[52px]">
                        Real-time portfolio monitoring with intelligent alerts
                      </p>
                    </div>

                    <div className="group bg-gradient-to-r from-white/5 to-white/10 rounded-2xl p-5 border border-white/10 hover:border-yellow-500/50 hover:shadow-lg transition-all duration-300 cursor-pointer">
                      <div className="flex items-center gap-4 mb-3">
                        <div className="p-3 bg-yellow-500/20 rounded-xl group-hover:bg-yellow-500/30 transition-colors">
                          <MessageSquare className="h-6 w-6 text-yellow-400" />
                        </div>
                        <h3 className="font-semibold text-xl text-white group-hover:text-yellow-400 transition-colors">
                          Market Insights
                        </h3>
                      </div>
                      <p className="text-gray-400 leading-relaxed pl-[52px]">
                        Expert analysis and real-time market commentary
                      </p>
                    </div>
                  </div>

                  {/* Live Updates Section */}
                  <div className="mt-8 bg-gradient-to-r from-green-500/10 to-blue-500/10 rounded-2xl p-5 border border-green-500/20">
                    <div className="flex items-center gap-3 mb-3">
                      <TrendingUp className="h-5 w-5 text-green-400" />
                      <span className="font-semibold text-green-400">Live Updates</span>
                    </div>
                    <StockTicker className="mt-2" />
                  </div>
                </div>
              </div>
            </div>

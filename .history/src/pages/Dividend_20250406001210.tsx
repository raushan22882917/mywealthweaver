                ...
                .map((stock, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">
                      ${typeof stock.dividendRate === 'number' ? stock.dividendRate.toFixed(2) : parseFloat(stock.dividendRate || '0').toFixed(2)}
                    </td>
                    <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">
                      {typeof stock.dividendYield === 'number' ? (stock.dividendYield * 100).toFixed(2) : (parseFloat(stock.dividendYield || '0') * 100).toFixed(2)}%
                    </td>

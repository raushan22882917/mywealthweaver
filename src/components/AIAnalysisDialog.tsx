...
export function AIAnalysisDialog({ isOpen, onClose, symbol, companyName, sector, currentPrice }: AIAnalysisDialogProps) {
  ...
  // Automatically trigger analysis when dialog opens
  useEffect(() => {
    if (isOpen && !isLoading && !analysis) {
      handleAnalyze();
    }
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        {!analysis && !isLoading && (
          <div className="flex flex-col items-center justify-center py-12">
            <BarChart className="h-16 w-16 text-muted-foreground mb-4 animate-pulse" />
            <h3 className="text-xl font-semibold mb-2">Preparing AI Stock Analysis</h3>
            <p className="text-muted-foreground text-center mb-6 max-w-md">
              Gathering data and initializing analysis for <span className="font-bold">{symbol}</span>.<br />Please wait a moment...
            </p>
          </div>
        )}
        ...
        {isLoading && (
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <h3 className="text-xl font-semibold mb-2">Analyzing <span className="font-bold">{symbol}</span>...</h3>
            <p className="text-muted-foreground text-center max-w-md">
              Our AI is performing a comprehensive analysis of <span className="font-bold">{companyName}</span>.<br />This may take a moment.
            </p>
          </div>
        )}

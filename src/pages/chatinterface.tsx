...
import { Loader2, Send, FileText, MessageSquare, AlertCircle, CheckCircle, RefreshCw, ArrowLeft, Eye } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/30">
      ...
      <div className="container mx-auto px-4 py-6 h-[calc(100vh-4rem)]">
        <div className="grid grid-cols-12 gap-6 h-full">
          {/* Left Panel - PDF Selection (unchanged as requested) */}
          ...
          {/* Right Panel - PDF Preview and Chat Interface */}
                        ...
                        <div className="text-center space-y-4">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground mt-2">
                              Use the chat interface to analyze this document
                            </p>
                          </div>
                        </div>
                      </div>
